...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <div class="content">
            <div class="gallery">
                <a href="#" class="gallery-link gallery-link-prev is-disabled"><span>Foto anterior</span></a>
                <div class="gallery-photo-area">
                    <div class="gallery-placeholder">
                        <span class="gallery-placeholder-msg">Você ainda não possui nenhuma foto cadastrada.</span>
                    </div>
                </div>
                <a href="#" class="gallery-link gallery-link-next is-disabled"><span>Foto seguinte</span></a>
            </div>
        </div>
        ...
        <div class="float-box">
            <form class="form-add-photo" action="add.php" method="post" enctype="multipart/form-data">
                ...
                <input class="form-add-photo-input js-input-file" type="file" name="fileToUpload" id="fileToUpload">
